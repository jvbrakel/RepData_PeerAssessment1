...
The mean for total steps taken per day is `r format(mean_of_steps,digits = 2 )`.  
The median for total steps taken per day is `r format(median_of_steps,digits = 2 )`.
...
There are  `r nrow(Missing_activity)` total number of missing values in the dataset (i.e. the total number of rows with NAs).  
...
The mean for total steps taken per day is `r format(mean_of_steps_filled_in,digits = 2 )`.  
The median for total steps taken per day is `r format(median_of_steps_filled_in,digits = 2 )`.
...
```
The variance in mean for total steps taken per day is `r format(variance_mean,digits = 2 )`.  
The variance in median for total steps taken per day is `r format(variance_median,digits = 2 )`.
