...
The mean for total steps taken per day is `r mean_of_steps_filled_in`.  
The median for total steps taken per day is `r median_of_steps_filled_in`.
...
```
The variance in mean for total steps taken per day is `r variance_mean`.  
The variance in median for total steps taken per day is `r variance_median`.
